...
copy_if_exists ~/scratch/scripts/install/expose/configure_iap_expanded.md deployment_config_files
copy_if_exists ~/scratch/scripts/install/expose/openapi_expanded.yml deployment_config_files
